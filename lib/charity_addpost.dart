...
class CharityAddPost extends StatefulWidget {
  final int userID;

  const CharityAddPost({super.key, required this.userID});

  @override
  _CharityAddPostState createState() => _CharityAddPostState();
}

//addpost
class _CharityAddPostState extends State<CharityAddPost> {
  ...
  Future<void> _uploadAndSaveImage() async {
    ...
    try {
      final fileName =
          'post_${widget.userID}_${DateTime.now().millisecondsSinceEpoch}${path.extension(_imageFile!.path)}';
  ...
  Future<void> _submitPost() async {
    ...
    try {
      final response =
          await Supabase.instance.client.from('charity_posts').insert({
            ...
            children: [
                  ...
                  children: [
                    Container(
                      ...
                      child: _imageFile != null
                          ...
                          // ? Image.file(_imageFile!, fit: BoxFit.cover) //og
              ...
              ElevatedButton(
                ...
                child: _isSubmitting
                    ...
                    : const Text('Submit'),
                // issue, only submit after image success upload, or else, the link will not appear in db
              ),
            ],
          ),
        ),
